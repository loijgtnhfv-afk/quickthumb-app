...
**Cost ≈ $0.067/image** (nano-banana-2 @2K); a default 4-style generation ≈ $0.27, all 10 ≈ $0.67. Iterate prompts/concepts offline with `scripts/preview-nbp.ts` (needs only `REPLICATE_API_TOKEN`; output in `.preview-nbp/`).
